...
### 1) Input System
- **Tech**: Unity Input System (`Assets/InputSystem_Actions.inputactions`).
...
## Credits
- Design and programming: Student project for “Intro to Unity”.
- Inspiration: Jump King by Nexile Studio.
